...
var formData = new _vue2.default({
  ...
  mounted: function mounted() {
    var accid = '80369525a7fe65f9f3774.20254132';
    var token = 'c2bc9a05f6f2143f3cb0285ce20429f4';
    var roomid = '22681813';
    _cookie2.default.setCookie('uid', accid.toLowerCase());
    _cookie2.default.setCookie('sdktoken', token.toLowerCase());
