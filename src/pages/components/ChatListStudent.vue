<template>
  <ul id="chat-list" class="m-chat-list p-chat-list student">
	    ...
	    >
	      ...
	      <p class="msg-user" v-else-if="msg.type!=='notification'">
		      ...
		      <span class="page_msgMe" v-if="msg.fromAvatar!==''">
		        <img class="myItem-me" :src="msg.fromAvatar" alt=""><!-- v-if="msg.flow==='out'" -->
		      </span>
		      <span class="page_msgMe" v-if="msg.fromAvatar===''">
		        <img class="myItem-me" src="http://college.m-fyd.com/assets/yunxin/res/im/tourists.png" alt="">
		      </span>
